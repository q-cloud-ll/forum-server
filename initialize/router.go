...
func Routers() *gin.Engine {
	...
	forumRouter := router.RouterGroupApp.Forum
	...
	// Router.Use(middleware.LoadTls())  // 如果需要使用https 请打开此中间件 然后前往 core/forum.go 将启动模式 更变为 Router.RunTLS("端口","你的cre/pem文件","你的key文件")
	// 跨域，如需跨域可以打开下面的注释
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		// Code generated by github.com/flipped-aurora/gin-vue-admin/forum Begin; DO NOT EDIT.

		// Code generated by github.com/flipped-aurora/gin-vue-admin/forum End; DO NOT EDIT.
	}
	...
	// 业务路由组，不走casbin
	myPrivateGroup := Router.Group("api")
	myPrivateGroup.Use(middleware.JWTAuth())
	{
		// 鉴权之后路由
		...
		forumRouter.InitFollowRouter(myPrivateGroup)
	}
